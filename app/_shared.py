...
PHASES: tuple[Phase, ...] = (
    ...
    Phase(3, "Match result prediction (GNN + Transformer)", False,
          "Windowed graph sequences and labels exist; the model does not."),
    Phase(4, "Recurring tactical patterns", False,
          "Possession chains are reconstructed; the sequence clustering is not built."),
